...
@section('content')
        ...
        <div class="Modern-Slider">
            ...
            <div class="item">
                <div class="img-fill">
                    ...
                    <div class="text-content">
                        <h3>Porque su salud es primordial</h3>
                        <h5>Forman parte de su familia</h5>
                    </div>
                </div>
            </div>
            <!-- // Item -->
    ...
    <!-- ***** About Area Starts ***** -->
    <section class="section principal" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>¿Qué encontrará con nosotros?</h6>
                            <h2>Nuestro servicio es integral</h2>
                        </div>
                        <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p>
                            <a rel="nofollow noopener" href="https://templatemo.com/tm-543-breezed" target="_parent">Breezed
                                HTML Template</a> is provided by TemplateMo for absolutely free of charge. You can download,
                            edit and use this for your non-commercial and commercial websites.
                            ...
                            template. Thank you.
                            <br><br>This is a Bootstrap v4.3.1 CSS layout. Do you like it? You can feel free to
                            <a rel="nofollow noopener" href="https://templatemo.com/contact" target="_parent">talk to us</a>
                            if you have anything.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            <h4>Initial Work</h4>
                            <p>Proin euismod sem ut diam ultricies, ut faucibus velit ultricies.
                                Nam eu turpis quam. Duis ac condimentum eros.</p>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit"
                                                    class="main-button">Subscribe Now</button>
                                        </fieldset>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="filters-content">
                        <div class="row grid">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-01.jpg')}}" data-lightbox="image-1"
                                       data-title="Our Projects"><img src="{{asset('images/project-item-01.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-02.jpg')}}" data-lightbox="image-1"
                                       data-title="Our Projects"><img src="{{asset('images/project-item-02.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all gra">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-03.jpg')}}" data-lightbox="image-1"
                                       data-title="Our Projects"><img src="{{asset('images/project-item-03.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all tsh">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-04.jpg')}}" data-lightbox="image-1"
                                       data-title="Our Projects"><img src="{{asset('images/project-item-04.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all dev">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-05.jpg')}}" data-lightbox="image-1"
                                       data-title="Our Projects"><img src="{{asset('images/project-item-05.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 all des">
                                <div class="item">
                                    <a href="{{asset('images/project-big-item-06.jpg')}}" data-lightbox="image-1"
                                       data-title="Our Projects"><img src="{{asset('images/project-item-06.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
